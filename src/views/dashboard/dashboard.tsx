...
// core components
import { Card , CardBody, CardFooter, CardHeader, CardIcon } from "../../components/card";
                ...
                <Card chart className={classes.cardHover}>
                  <CardHeader color="info" className={classes.cardHeaderHover}>
                    <ChartistGraph
                      ...
                      // TODO : Update when pull request is accepted and merged into master.
...
(Dashboard as React.ComponentClass<DashboardProps>).propTypes = {
