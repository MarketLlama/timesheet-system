...
import { customCheckboxRadioSwitch } from "../../assets/jss";
...
export interface FixedPluginProps extends WithStyles<typeof customCheckboxRadioSwitch> {
    color: string;
    bgColor: bgColorType;
    bgImage: string;
    miniActive: boolean;
    ...
    handleBgColorClick: (color: string) => void;
    handleFixedClick: () => void;
    sidebarMinimize: () => void;
    fixedClasses: string;
}

export interface FixedPluginState {
    showImage: boolean;
    classes: string;
    bg_checked: boolean;
    bgImage: string;
              ...
              <ul className="dropdown-menu">
                ...
                <li className="adjustments-line">
                  <a className="switch-trigger">
                    ...
                    <Switch
                      ...
                      onChange={this._handleChange("miniActive")}
                      value="sidebarMini"
                      classes={{
                ...
                <li className="button-container">
                  <div>
                    <Button
                      color="warning"
                      href="https://www.google.com/product/material-dashboard-pro-react"
                      target="_blank"
                      fullWidth
                    >
                      Buy now
...
export default withStyles(customCheckboxRadioSwitch)(FixedPlugin);
